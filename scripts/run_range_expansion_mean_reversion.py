#!/usr/bin/env python3
"""Single frozen OHLCV range-expansion mean-reversion experiment.
...
def main() -> int:
    ...
    report = {
        ...
        "hypothesis": "high-volume downside range-expansion shock mean-reverts over the next six hours",
        "frozen_parameters": {
