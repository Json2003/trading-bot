"""Optional local stub that forwards to real pandas.

This file exists only to document prior behavior when a repo-local
`pandas.py` shadowed the real package. It is not imported by the
