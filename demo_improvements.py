...
def demo_file_structure():
    ...
    enhancements = {
        ...
        "Enhanced WebSocket Server": ["server.py"],
        "Enhanced Backtesting Framework": ["tradingbot_ibkr/backtest_ccxt.py"],
        "Enhanced Model Training": ["tradingbot_ibkr/models/train_batch.py"],
        "Enhanced Data Fetching": ["tradingbot_ibkr/run_fetch_one.py"],
        "Enhanced Market Data Crawler": ["binance_vision_size.py"],
        "Documentation & Testing": ["SETUP_GUIDE.md", "test_enhancements.py"],
    }
        ...
        if model_file.exists():
            ...
            features = [
                ...
                (
                    ...
                    "optuna" in content.lower() or "gridsearch" in content.lower(),
                ),
